...
<body>
    ...
    <div class="hero-header">
        <div class="hero-content">
            <h1 style="color: #ddd;"><i class="fas fa-calendar-alt"></i> Court Booking System</h1>
            <p>Manage all your court reservations in one place</p>
        </div>
    </div>
            ...
            fetch('api.php?action=create_booking', {
                ...
                .then(data => {
                    if (data.success) {
                        showAlert(
                            'Booking Successful',
                            `Your booking code is: ${data.booking_code}  Take screenshot your booking code`,
